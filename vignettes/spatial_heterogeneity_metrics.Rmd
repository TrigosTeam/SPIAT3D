...
knitr::include_graphics(system.file("extdata", "spatial_heterogeneity.png", package = "SPIAT3D"))
```
...
prism. The equation for entropy can be found in our manuscript/paper.
...
threshold, prevalence is simply the proportion of the rectangular prisms have a 
metric value above (or below) this threshold.

The metric values always range from 0 to 1 due to how the values are calculated,
so the threshold must be between 0 and 1.
