#' @title Find cell clusters in 3D spatial data using alpha hull clustering
#'     algorithm.
#'
#' @description This function finds cell clusters in a 3D SpatialExperiment
#'     object using the alpha hull clustering algorithm.
#'
...
#'     added column in the `colData` slot to specify which alpha hull cluster
