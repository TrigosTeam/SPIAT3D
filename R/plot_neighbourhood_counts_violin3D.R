...
#'
#' @importFrom ggplot2 ggplot aes geom_violin labs facet_wrap element_blank element_text theme_bw theme stat_summary
#'
#' @examples
...
#'
#' # Calculate neighbourhood counts from spe
